...
The R programming language [@R] and the following R packages were used to perform the analysis: knitr (Xie 2014) [@knitr], tidyverse (Wickham 2017) [@tidyverse], and bookdown (Xie 2016) [@bookdown]. *Note: this report is adapted from [@ttimbers-horses].*
